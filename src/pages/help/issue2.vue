    ...
    <div class="content">
      ...
      >
        <div class="issueContent">
          <p v-for="(list, index) in answerList">{{list}}</p>
        </div>
      </scroll>
    </div>
    <div class="bottom">
...
<script>
  ...
  export default {
    data () {
      return {
        answerList: this.$t('question.answer1')
      }
    },
    methods: {
      backTo () {
  ...
  .issue2
    ...
    .title
      ...
      p
        ...
        width:100%
    .content
      padding:0.91rem 0.32rem 0 0.32rem
      background:#fff
      font-size:0.3rem
      .issue_title
        height:1rem
