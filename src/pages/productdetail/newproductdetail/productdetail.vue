<template>
  <div class="productdetail" :class="{'noScroll': betstate}" @click="closeNavBar($event)">
      ...
      <div v-show="!loading">
        ...
        <div v-if="iconind === 1">
          <div class="imgcontainer">
            <img v-for="list in imglist"  :src="list" alt="">
          </div>
        </div>
        <div v-if="iconind===2">
    ...
    <div class="participation" @click.stop="betBtn" v-show="state !==3 && state !==2 && state!==5">
    ...
    <!-- <div class="newIssue" v-show="newIssueState">
      ...
      <p class="newwIssueBtn" @click.stop="toNewIssue">{{$t('product.Immediately_to')}}</p>
    </div> -->
